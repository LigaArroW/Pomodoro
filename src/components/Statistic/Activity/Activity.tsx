        ...
        {curentDay[0] && curentDay[0].pomidors > 0
          ...
          <>
            <div className={styles.pomidorBlock}>
              ...
              <svg className={styles.pomidorYes} width="81" height="81" viewBox="0 0 81 81" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className={styles.pomidorNo} width="115" height="115" viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg">
